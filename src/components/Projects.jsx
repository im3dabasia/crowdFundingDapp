...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div id="projects" className="rounded-lg shadow-lg bg-white w-128 m-4">
          ...
          <div className='flex flex-row  w-full h-1/2'>
            ...
            <div className="w-1/2 p-4 text-center	text-2xl	">
              ...
              <div className="flex flex-col ">
                <div className="flex justify-start text-center  text-blue-700   text-xlspace-x-2 items-center mb-3 ">
                  {truncate(project.owner, 8, 8, 24)}
                </div>
